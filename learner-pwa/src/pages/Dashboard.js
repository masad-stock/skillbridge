...
function Dashboard() {
    const { user, skillsProfile, learningPath, progress, assessmentResults, isOnline, loading } = useUser();
                        ...
                        <Col>
                            <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                                <div className="flex-grow-1">
                                    <h2 className="fw-bold mb-2" style={{ fontSize: 'clamp(1.5rem, 4vw, 2rem)' }}>
                                        Welcome back, {user.profile?.firstName || user.email || 'User'}! 👋
                                    </h2>
                                    <p className="text-muted mb-0" style={{ fontSize: 'clamp(0.9rem, 2vw, 1rem)' }}>
                                        Your personalized learning journey starts here
                                    </p>
                                </div>
                                {!isOnline && (
                                    <Alert variant="info" className="mb-0 flex-shrink-0">
                                        ...
                                        <Row className="align-items-center">
                                            <Col md={8}>
                                                <h4 className="fw-bold mb-2">
                                                    <span className="me-2">🎯</span>
                                                    Start Your Journey: Take the Skills Assessment
                                                </h4>
                                                <p className="mb-0">
                                                    Complete a quick assessment to unlock your personalized learning path.
                                                    This helps us understand your current skills and recommend the best courses for you.
                                                </p>
                                            </Col>
                                            <Col md={4} className="text-center">
                                                ...
                                                <div className="mt-2">
                                                    <small>⏱️ Takes 5-10 minutes</small>
                                                </div>
                                            </Col>
                                        </Row>
                                    </Card.Body>
                                    ...
                                    <Card.Body className="p-3">
                                        ...
                                        <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <small className="fw-bold d-block">Assessment</small>
                                                    <small className="text-success">Completed</small>
                                                </div>
                                            </div>

                                            <div className="flex-grow-1 border-top mx-2" style={{ minWidth: '30px' }}></div>

                                            {/* Step 2: Learning Path */}
                                            <div className="d-flex align-items-center">
                                                <div className={`${learningPath && learningPath.length > 0 ? 'bg-success' : 'bg-primary'} text-white rounded-circle d-flex align-items-center justify-content-center me-2`}
                                                    style={{ width: '40px', height: '40px', minWidth: '40px' }}>
                                                    <span>{learningPath && learningPath.length > 0 ? '✓' : '2'}</span>
                                                </div>
                                                <div>
                                                    <small className="fw-bold d-block">Learning Path</small>
                                                    <small className={learningPath && learningPath.length > 0 ? 'text-success' : 'text-primary'}>
                                                        {learningPath && learningPath.length > 0 ? 'Active' : 'Ready'}
                                                    </small>
                                                </div>
                                            </div>
                                            ...
                                            {/* Step 3: Courses */}
                                            <div className="d-flex align-items-center">
                                                <div className={`${getTotalCompletedModules() > 0 ? 'bg-primary' : 'bg-secondary'} text-white rounded-circle d-flex align-items-center justify-content-center me-2`}
                                                    style={{ width: '40px', height: '40px', minWidth: '40px' }}>
                                                    <span>3</span>
                                                </div>
                                                <div>
                                                    <small className="fw-bold d-block">Courses</small>
                                                    <small className={getTotalCompletedModules() > 0 ? 'text-primary' : 'text-muted'}>
                                                        {getTotalCompletedModules()} / {learningPath?.length || 0}
                                                    </small>
                                                </div>
                                            </div>
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <small className="fw-bold d-block">Business Tools</small>
